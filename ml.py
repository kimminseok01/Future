...
#label '1' as non-cancer and '2' as cancer
tn = ['non-cancer','cancer']

#get accuracy and report of each algorithms
accuracy_1 = metrics.accuracy_score(y_test, pred_1)
report_1 = metrics.classification_report(y_test, pred_1, target_names = tn)

accuracy_2 = metrics.accuracy_score(y_test, pred_2)
report_2 = metrics.classification_report(y_test, pred_2, target_names = tn)

accuracy_3 = metrics.accuracy_score(y_test, pred_3)
report_3 = metrics.classification_report(y_test, pred_3, target_names = tn)
